  ...
  return (
    <>
      ...
      <div
        ...
        xs:h-[3300px] xs:flex xs:flex-col xs:relative xs:items-center xs:overflow-hidden xs:bg-amber-500 xs:text-slate-100"
      >
        ...
        <div className="flex relative top-[180px] text-gray-700 xs:relative xs:top-[650px] xs:w-[450px] xs:text-slate-100">
          ...
          <div className="flex flex-col relative  min-h-screen right-[150px] top-[80px] w-full space-y-2 xs:right-[270px] xs:flex xs:flex-col ">
            <div className="flex flex-row relative bg-slate-50 h-[350px] top-[20px]  w-full space-x-2 xs:bg-amber-500 xs:relative xs:left-8 xs:w-[350px]  ">
              <div
                className="w-[500px] h-[350px] bg-slate-50  flex flex-col space-y-2 justify-center items-center  relative 
              xs:relative xs:top-[240px] xs:text-center xs:rounded-md xs:pt-[120px] xs:bg-amber-500"
              >
            ...
            <div className="flex flex-row relative bg-slate-50 h-[350px] top-[0px]  xs:top-[1000px]  xs:bg-amber-500 xs:flex xs:flex-col xs:relative xs:left-8 xs:w-[350px]">
              <div
                className="w-[500px] h-[350px] bg-slate-50  flex flex-col space-y-2 justify-center items-center  relative 
              xs:bg-amber-500 xs:relative xs:top-[300px] xs:left-[-490px]  xs:w-[350px] xs:text-center"
              >
                <img
                  src="/football1.jpg"
                  className="w-[300px] absolute h-[330px] flex  bottom-[10px]  rounded-[20px] hover:transition hover:duration-1000
            ...
            <div className="flex flex-row relative bg-slate-50 h-[350px] top-[-10px] xs:flex xs:flex-col  xs:bg-amber-500 xs:relative xs:left-8 xs:w-[350px]">
              <div
                className="w-[500px] h-[350px] bg-slate-50  flex flex-col space-y-2 justify-center items-center  relative 
              xs:bg-amber-500 xs:relative xs:top-[300px]  xs:w-[350px] xs:text-center "
              >
                <span className="font-manrope font-[600] text-[20px] transitionhover relative xs:w-[350px]">
